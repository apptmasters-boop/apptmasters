        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span className="text-sm text-gray-600 leading-snug">
              ...
              <Link href="/terms" target="_blank" className="text-indigo-600 font-medium hover:underline">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" target="_blank" className="text-indigo-600 font-medium hover:underline">
                Privacy Policy
              </Link>
            </span>
          </label>
