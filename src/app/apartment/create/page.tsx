...
export default function CreateApartmentPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    setError("");
    const res = await apiFetch("/api/apartments", { method: "POST", body: JSON.stringify({ name, address }) });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">Give your place a name and address your roommates will recognize.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="text" required placeholder="e.g. 123 Main St, Apt 4B, New York, NY 10001"
